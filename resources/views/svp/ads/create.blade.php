                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <form action="store" method="post" enctype="multipart/form-data" class="form-horizontal" data-pg-collapsed>
                                {{ csrf_field() }}
                                <div class="row form-group" data-pg-collapsed>
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="name" name="name" placeholder="Name your advertisement" class="form-control">
                                    </div>
                                </div>
                                <div class="row form-group" data-pg-collapsed>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                    <input type="text" id="price" name="price" placeholder="Price to pay for the advertisement" class="form-control" readonly="readonly" value="{{$bottom_ad_price}}">
                                    </div>
                                </div>
