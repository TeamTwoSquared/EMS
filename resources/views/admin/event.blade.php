...
<div class="row" data-pg-collapsed>
    <div class="col-md-12" data-pg-collapsed>
        <!-- DATA TABLE -->
        <h3 class="title-5 m-b-35" data-pg-collapsed>data table</h3>
        <div class="table-data__tool" data-pg-collapsed>
        ...
        <div class="table-responsive table-responsive-data2" data-pg-collapsed>
            <table class="table table-data2" data-pg-collapsed>
                <thead>
                    <tr>
                        <th>
