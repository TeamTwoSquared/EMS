...
<div class="container" data-pg-collapsed>
    ...
    <div>
        <div class="row" data-pg-collapsed>
            <div class="col-md-1" data-pg-collapsed>
                <img  140x140 class="img-circle img-responsive" src="\storage\images\services\{{$customer_info[0]->profilepic}}">
            </div>
                                    ...
                                    @foreach($issue_image as $image)
                                     <div class="col-md-4">
                                        <div class="card mb-4 box-shadow">
                                                ...
                                                <img class="card-img-top" data-enlargable  src="\storage\images\services\{{$image->attachement_url}}" />
                                        </div>
                                     </div>
                                    @endforeach
                                @endif
  ...
  @if(count($_comment)==0)
        ...
        <form action="/notification/sendReply" method="POST">
            <div class="row" data-pg-collapsed>
                <div class="col-md-1">
                </div>
                <div class="col-md-10" data-pg-collapsed> 
                        <div class="container">
                                ...
                                <div class="md-form">
                                    ...
                                    <textarea type="text" name="comment" class="md-textarea form-control" rows="3"></textarea>
                                </div>
                                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                                </nav>                      
                        </div>
